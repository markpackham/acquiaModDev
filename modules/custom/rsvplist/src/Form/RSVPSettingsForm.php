...
/**
 * Define a form to config RVSP List module settings
 */
...
class RSVPSettingsForm extends ConfigFormBase
{
    ...
    public function buildForm(array &$form, FormStateInterface $form_state, Request $request = null)
    {
        ...
        $form['rsvplist_types'] = array(
            ...
            '#options' => $types,
            '#description' => t('On the specific node types, an RSVP option will be available & can be enabled while that node is being edited.'),
        );
